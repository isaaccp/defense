...
func _on_configure_behavior_pressed(character_idx: int):
	...
	programming_ui.initialize("Configuring behavior for %s" % gameplay_character.name, gameplay_character.behavior, gameplay_character.skill_tree_state, behavior_library)
