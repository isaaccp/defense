...
# and applying Chilled (-50% speed, 3s) to everything in radius. Damage is
# intentionally low — it's a setup spell that turns enemies into one-shot
# fodder for follow-up rules (e.g. Seeking Bolt picks off chilled grunts).
...
func description() -> String:
	return "Drops a chilling sphere at a position, dealing 3 frost damage and slowing enemies in the area (Chilled, -50% speed for 3s)."
